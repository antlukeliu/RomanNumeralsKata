...
public class AraNumToRomNumConverterTest {
	
	AraNumToRomNumConverter converter;

	@Before
	public void setUp(){
		converter = new AraNumToRomNumConverter();
	}
	...
	public void testForThousand() {
		...
		assertEquals("MXXXIV", converter.convert("1034"));
		assertEquals("ML", converter.convert("1050"));
